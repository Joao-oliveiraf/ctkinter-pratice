...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # Frames com checkbox
        self.checkbox_frame = ScrollableFrame(self, values=['Value 1', 'Value 2', 'Value 3', 'Value 4', 'Value5'],
                                              title='Values')
        self.checkbox_frame.grid(row=0, column=0, padx=10, pady=(10, 0), sticky='new')
        ...
        self.checkbox_frame2.grid(row=0, column=1, padx=10, pady=(10, 0), sticky='new')
        self.checkbox_frame2.configure(fg_color='gray10')
        self.checkbox_frame3 = ScrollableFrame(self, values=['Value 1', 'Value 2', 'Value 3'], title='Values')
        self.checkbox_frame3.grid(row=0, column=2, padx=10, pady=(10, 10), sticky='new')
